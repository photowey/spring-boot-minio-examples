...
class MinioTemplateTest extends AbstractTest {
    ...
    void testCreateBuckets() {
        boolean ok = this.minioTemplate.createBucket("linkinpark");
        Assertions.assertTrue(ok);

        boolean failed = this.minioTemplate.createBucket("linkinpark");
        Assertions.assertFalse(failed);
    }

    @Test
    void testBucketExists() {
        boolean exists = this.minioTemplate.bucketExists("linkinpark");
